...
public class Result implements org.apache.thrift.TBase<Result, Result._Fields>, java.io.Serializable, Cloneable, Comparable<Result> {
  ...
  private static final org.apache.thrift.protocol.TField ORDER_SEAT_DTO_FIELD_DESC = new org.apache.thrift.protocol.TField("orderSeatDto", org.apache.thrift.protocol.TType.STRUCT, (short)1);
  ...
  public @org.apache.thrift.annotation.Nullable com.orderseat.facade.dto.OrderSeatDto orderSeatDto; // required
  public @org.apache.thrift.annotation.Nullable java.lang.String status; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ORDER_SEAT_DTO((short)1, "orderSeatDto"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        case 1: // ORDER_SEAT_DTO
          return ORDER_SEAT_DTO;
        case 2: // STATUS
          return STATUS;
        default:
          return null;
  ...
  static {
    ...
    tmpMap.put(_Fields.ORDER_SEAT_DTO, new org.apache.thrift.meta_data.FieldMetaData("orderSeatDto", org.apache.thrift.TFieldRequirementType.REQUIRED, 
  ...
  public Result(
    com.orderseat.facade.dto.OrderSeatDto orderSeatDto,
    java.lang.String status)
  {
    this();
    this.orderSeatDto = orderSeatDto;
    this.status = status;
  }
  ...
  public Result(Result other) {
    if (other.isSetOrderSeatDto()) {
      this.orderSeatDto = new com.orderseat.facade.dto.OrderSeatDto(other.orderSeatDto);
    }
  ...
  @Override
  public void clear() {
    this.orderSeatDto = null;
    this.status = null;
  }

  @org.apache.thrift.annotation.Nullable
  public com.orderseat.facade.dto.OrderSeatDto getOrderSeatDto() {
    return this.orderSeatDto;
  }

  public Result setOrderSeatDto(@org.apache.thrift.annotation.Nullable com.orderseat.facade.dto.OrderSeatDto orderSeatDto) {
    this.orderSeatDto = orderSeatDto;
    return this;
  }

  public void unsetOrderSeatDto() {
    this.orderSeatDto = null;
  }

  /** Returns true if field orderSeatDto is set (has been assigned a value) and false otherwise */
  public boolean isSetOrderSeatDto() {
    return this.orderSeatDto != null;
  }

  public void setOrderSeatDtoIsSet(boolean value) {
    if (!value) {
      this.orderSeatDto = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ORDER_SEAT_DTO:
      if (value == null) {
        ...
        setOrderSeatDto((com.orderseat.facade.dto.OrderSeatDto)value);
      }
      break;
  ...
  public boolean equals(Result that) {
    ...
    boolean this_present_orderSeatDto = true && this.isSetOrderSeatDto();
    boolean that_present_orderSeatDto = true && that.isSetOrderSeatDto();
    if (this_present_orderSeatDto || that_present_orderSeatDto) {
      if (!(this_present_orderSeatDto && that_present_orderSeatDto))
        return false;
      if (!this.orderSeatDto.equals(that.orderSeatDto))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetOrderSeatDto()) ? 131071 : 524287);
    if (isSetOrderSeatDto())
      hashCode = hashCode * 8191 + orderSeatDto.hashCode();
  ...
  public int compareTo(Result other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetOrderSeatDto()).compareTo(other.isSetOrderSeatDto());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOrderSeatDto()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.orderSeatDto, other.orderSeatDto);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    sb.append("orderSeatDto:");
    if (this.orderSeatDto == null) {
      sb.append("null");
    } else {
      sb.append(this.orderSeatDto);
    }
    first = false;
    if (!first) sb.append(", ");
    sb.append("status:");
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (orderSeatDto == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'orderSeatDto' was not present! Struct: " + toString());
    }
    if (status == null) {
  ...
  private static class ResultStandardScheme extends org.apache.thrift.scheme.StandardScheme<Result> {
        ...
        switch (schemeField.id) {
          case 1: // ORDER_SEAT_DTO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.orderSeatDto = new com.orderseat.facade.dto.OrderSeatDto();
              struct.orderSeatDto.read(iprot);
              struct.setOrderSeatDtoIsSet(true);
            } else { 
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Result struct) throws org.apache.thrift.TException {
      ...
      if (struct.orderSeatDto != null) {
        oprot.writeFieldBegin(ORDER_SEAT_DTO_FIELD_DESC);
        struct.orderSeatDto.write(oprot);
        oprot.writeFieldEnd();
      }
